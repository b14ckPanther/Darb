...
Production server-only variables are `DARB_VERCEL_API_TOKEN`,
`DARB_VERCEL_RESTAURANT_PROJECT_ID`, optional `DARB_VERCEL_TEAM_ID`, and
`SUPABASE_SECRET_KEY` for the narrow attestation RPCs.
