...
export const mainSiteCopy: Readonly<Record<SupportedLocale, MainSiteCopy>> = {
  ar: {
      ...
      items: [
        {
          ...
          title: "المطاعم",
          description:
            "كل اللي بحتاجه محلك عشان يقدّم حاله للزبون بشكل مرتب، واضح، وسهل يتصفّح من أي جهاز.",
          current: true,
        },
        {
          key: "booking",
          title: "الحجوزات",
          description:
            "نظّم خدماتك، مواعيدك ووقتك، وخلي زباينك يحجزوا بالطريقة اللي بتريحهم وبتريحك.",
          current: false,
        },
        {
          key: "pages",
          title: "الصفحات",
          description:
            "ابني لشغلك موقع عالويب يعرّف عنك، يعرض اللي بتقدّمه، ويعطي الناس كل اللي لازم يعرفوه عنك.",
          current: false,
        },
        {
          key: "commerce",
          title: "التجارة",
          description:
            "حوّل منتجاتك لماركت أونلاين مرتب، وخلي زباينك يتصفّحوا، يختاروا ويشتروا بسهولة.",
          current: false,
        },
      ],
    ...
    finalCta: {
      ...
      description:
        "ادخل على حسابك وكمل إدارة شغلك، البزنسات والمنتجات المفعّلة إلك من نفس المحل تحت نفس السقف.",
      action: "تسجيل الدخول",
    },
    footer: {
  ...
  he: {
    ...
    products: {
      ...
      honestNote: "המוצרים האלה הם רק הצצה ראשונה — ל-Darb יש עוד הרבה יותר להציע.",
    },
    foundation: {
      eyebrow: "יש לך יותר מעסק אחד?",
      title: "Darb מרכז את כולם ועוזר לך לנהל הכול תחת קורת גג אחת.",
      description:
      ...
      items: [
...

        {
          ...
          description: "Darb בנוי לריבוי שפות מהיום הראשון.",
        },
  ...
  en: {
    ...
    products: {
      ...
      honestNote: "These products are only a first glimpse — Darb has much more ahead.",
    },

    foundation: {
      eyebrow: "Running more than one business?",

      title: "Darb brings them together and helps you manage everything under one roof.",
