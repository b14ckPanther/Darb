...
export const mainSiteCopy: Readonly<Record<SupportedLocale, MainSiteCopy>> = {
  ar: {
    ...
    brandDescriptor: "منصة تجارب الأعمال",
    nav: {
      primaryNavigation: "التنقل الرئيسي",
      story: "ما هو درب",
      paths: "مسارات الأعمال",
      products: "المنتجات",
      foundation: "المنصة",
      signIn: "دخول الإدارة",
    ...
    hero: {
      eyebrow: "بداية رقمية تفتح أكثر من طريق",
      titleLead: "عملك.",
      titleAccent: "بطريقك.",
      description:
        "درب منصة مرنة تبني لعملك حضورًا رقميًا متكاملًا، وتمنحك الأدوات التي تحتاجها اليوم والمساحة التي تحتاجها غدًا.",
      primaryAction: "اكتشف درب",
      secondaryAction: "دخول الإدارة",
      imageAlt: "مدخل معماري مضاء يفتح على أفق جديد",
      scrollLabel: "تابع لاكتشاف درب",
    },
    story: {
      eyebrow: "درب واحد، إمكانات متعددة",
      title: "منصة تنطلق من هوية عملك، لا من قالب جاهز.",
      body: "يجمع درب الأساس الرقمي لعملك في مكان واحد، ثم يتيح لك تفعيل القدرات المناسبة لطبيعة نشاطك. تبدأ بهوية واضحة، مواقع ولغات ومظهر ونطاق خاص، وتتوسع فقط عندما تحتاج.",
      principle: "أساس واحد. أعمال مختلفة. مسارات متعددة.",
    },
    paths: {
      eyebrow: "لكل عمل مساره",
      title: "نفس الأساس، بتجربة تناسب طبيعة عملك.",
      description:
        "لا يفرض درب وجهة واحدة. يربط الأساس المشترك بمنتجات متخصصة تُبنى بعناية لكل نوع من الأعمال.",
      items: [
        {
          title: "المطاعم والمقاهي",
          status: "متاح الآن",
          description: "قوائم متعددة اللغات، فروع، نطاقات وهوية بصرية ضمن تجربة مطاعم متكاملة.",
        },
        {
          title: "الصالونات والجمال",
          status: "مسار قادم",
          description: "اتجاه مستقبلي للخدمات والفرق والمواعيد، مبني على نفس أساس درب.",
        },
        {
          title: "المهنيون والعيادات",
          status: "مسار قادم",
          description: "اتجاه مستقبلي لتنظيم الخدمات والمواعيد وحضور الفرق المهنية.",
        },
        {
          title: "التجزئة",
          status: "مسار قادم",
          description: "اتجاه مستقبلي للكتالوج والتجارة ضمن هوية العمل الواحدة.",
        },
      ],
    },
    products: {
      eyebrow: "منتجات درب",
      title: "قدرات تتفعّل عندما يصبح وقتها مناسبًا.",
      description:
        "كل منتج في درب مجال عملي مستقل، لكنه يستفيد من الهوية والمواقع واللغات والمظهر نفسها.",
      available: "منتج متاح",
      future: "قادم لاحقًا",
      items: [
        {
          key: "restaurant",
          title: "درب للمطاعم",
          description: "إدارة وتجربة عامة لقوائم الطعام متعددة اللغات، الفروع والمظهر والنطاقات.",
          current: true,
        },
        {
          key: "booking",
          title: "الحجوزات",
          description: "مسار مستقبلي للخدمات والمواعيد والموارد المتاحة.",
          current: false,
        },
        {
          key: "pages",
          title: "الصفحات",
          description: "مسار مستقبلي لحضور محتوى أوسع ضمن منصة درب.",
          current: false,
        },
        {
          key: "commerce",
          title: "التجارة",
          description: "مسار مستقبلي للكتالوج وتجارب الشراء.",
          current: false,
        },
      ],
      honestNote: "الحجوزات والصفحات والتجارة اتجاهات مستقبلية وليست منتجات متاحة بعد.",
    },
    foundation: {
      eyebrow: "الأساس المشترك",
      title: "تفاصيل عملك تبقى متماسكة مهما اتسع المسار.",
      description:
        "بدل تكرار المعلومات بين أدوات منفصلة، يحافظ درب على عناصر عملك الأساسية ضمن بنية واحدة واضحة.",
      items: [
        { title: "هوية العمل", description: "اسم وحضور أساسي موحّد لكل قدرات درب." },
        { title: "المواقع", description: "فروع واضحة تخدم تجارب عمل مختلفة." },
        { title: "اللغات", description: "العربية والعبرية والإنجليزية من البداية." },
        { title: "المظهر", description: "نظام بصري مضبوط يعكس شخصية العمل." },
        { title: "النطاقات", description: "وجهة عامة موثوقة باسم العمل." },
        { title: "الوسائط", description: "صور وفيديوهات تُدار من مصدر واحد." },
      ],
    },
    languages: {
      eyebrow: "محلي منذ الأساس",
      title: "ثلاث لغات. اتجاهان. تجربة واحدة متقنة.",
      description:
        "صُمم درب للسوق المحلي كما هو: العربية والعبرية باتجاه من اليمين إلى اليسار، والإنجليزية باتجاهها الطبيعي، من دون أن تكون أي لغة نسخة ثانوية.",
      scripts: [
    ...
    finalCta: {
      eyebrow: "الباب مفتوح",
      title: "ابدأ من أساس صُمم ليتحرك مع عملك.",
      description:
        "إذا كان لديك حساب في درب، انتقل إلى مساحة الإدارة لإدارة عملك ومنتجاته المتاحة.",
      action: "دخول إدارة درب",
    },
    footer: {
      statement: "أساس رقمي واحد لمسارات أعمال متعددة.",
      admin: "إدارة درب",
    ...
    metadata: {
      ...
      description:
        "درب منصة تجارب أعمال متعددة اللغات تمنح الأعمال أساسًا رقميًا مرنًا وقدرات متخصصة تبدأ بالمطاعم.",
    },
    notFound: {
      title: "هذه الصفحة غير موجودة",
      description: "تعذّر العثور على الصفحة المطلوبة ضمن موقع درب.",
      action: "العودة إلى الرئيسية",
    },
    error: {
      title: "تعذّر تحميل الصفحة",
      description: "حدث خلل غير متوقع. يمكنك المحاولة مرة أخرى من دون عرض أي تفاصيل داخلية.",
